...
class Post(models.Model):
    ...
    text = RichTextField(blank=True, null=True, verbose_name='Сожержимое поста')
    TYPE = [
        ('tank', 'Танки'),
        ('healer', 'Хилы'),
        ('damage dealer', 'ДД'),
    ...
    img = models.ImageField(upload_to='post', null=True, blank=True, verbose_name='Изображение')
